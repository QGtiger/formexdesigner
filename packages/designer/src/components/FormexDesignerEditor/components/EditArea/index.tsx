import i18next from 'i18next';import PreviewDevFormex from "./PreviewDevFormex";

export default function EditArea() {
  return (
    <div className="flex flex-col h-full ">
      <div className=" h-[40px] flex-shrink-0 bg-white border-b border-gray-300  flex items-center justify-center text-sm font-semibold text-gray-600">{i18next.t("intl52")}
      ...
      <div className="editor-area-container flex justify-center h-1 flex-1 overflow-auto p-10">
        ...
        <div className="relative bg-white shadow-2xl rounded-xl  w-[800px] flex flex-col h-full">
          <div className="h flex justify-center relative bg-[#212936] p-2 flex-shrink-0 rounded-t-xl overflow-hidden">
            ...
            <div className="u bg-[#58606d] p-1 px-10 text-[#cccccc] rounded-md text-xs font-semibold ">{i18next.t("intl53")}
